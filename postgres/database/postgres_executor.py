...
class PostgresExecutor:
    ...
    def load_csv(self, row_num):
        ...
        load_csv_to_db(f'common/data/calls{row_num}.csv', '''
            INSERT INTO calls (id,  duration, call_date)
            VALUES (%s, %s, %s)
        ''')

        load_csv_to_db(f'common/data/contact_calls{row_num}.csv', '''
            INSERT INTO contacts_calls (contact_id, call_id)
            VALUES (%s, %s)
        ''')
    ...
    def drop_indexes(self):
        self.load_sql_file('postgres/scripts/drop_indexes.sql')  # check this path

    def create_indexes(self):
        self.load_sql_file('postgres/scripts/indexes.sql')

    def create_tables(self):
        self.load_sql_file('postgres/scripts/create.sql')
    ...
    def drop_all(self):
        self.load_sql_file('postgres/scripts/drop_all.sql')
